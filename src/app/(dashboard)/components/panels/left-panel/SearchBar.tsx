...
<div className="flex flex-row items-center justify-between">
    <div className="relative">
        ...
        <input type="search" autoComplete="off" id="default-search" defaultValue={searchedLocation} onInputCapture={handleInput} className="block w-full p-4 ps-10 text-sm text-gray-900 bg-transparent rounded-lg  focus:ring-blue-500  dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 " placeholder="Search for places..." required />
